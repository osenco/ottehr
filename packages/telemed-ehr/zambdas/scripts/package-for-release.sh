...
# Zip
ZIP_ORDER=("deactivate-user" "get-appointments" "get-telemed-appointments" "change-telemed-appointment-status" "get-chart-data" "save-chart-data" "delete-chart-data" "get-token-for-conversation" "update-user" "get-user" "init-telemed-session" "save-chart-data" "get-chart-data" "delete-chart-data")
